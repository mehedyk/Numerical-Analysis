(function () {
  ...
  /* Full-screen overlay shown during capture so the user never sees the
     export element flash on screen. z-index:99999 sits above exportEl. */
  ...
  /* Generic radio-group toggle (active-mode highlight), scoped to each
     ...
     on the page (stop-mode, bracket-mode) don't interfere with each other */
  ...
  D.precisionIn.addEventListener('blur', () => { D.precisionIn.value = _precision; });
